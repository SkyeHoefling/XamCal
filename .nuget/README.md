...
1. Navigate to [https://ci.appveyor.com/project/ahoefling/XamCal](https://ci.appveyor.com/project/ahoefling/XamCal) and retrieve the latest `.nupkg` from the build
